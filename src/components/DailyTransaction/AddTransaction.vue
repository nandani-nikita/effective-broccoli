            ...
            <form @submit.prevent="editingTransaction ? updateTransaction() : addTransaction()">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="short_name" v-model="selectedBank" class="form-control" required @change="onBankNameChange">
                            <option value="Select Bank" selected hidden>Select Bank</option>
                            <option v-for="bank in bankDetails" :key="bank._id" :value="bank">{{ bank.short_name }}
                            </option>
                        </select>
                    </div>
                    <!-- Transaction Date -->
                    <div class="form-group">
                        ...
                        <input type="date" id="transaction_date" v-model="formData.transaction_date"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bank_narration" v-model="formData.bank_narration" class="form-control"
                            required>
                    </div>
                    <!-- Value Date -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="payment_received_from" v-model="formData.payment_received_from"
                            class="form-control">
                    </div>
                    <!-- Payment Received For -->
                    <div class="form-group">
                        <label for="payment_received_for">Payment Received For:</label>
                        <input type="text" id="payment_received_for" v-model="formData.payment_received_for"
                            class="form-control">
                    </div>
                    <!-- Payment Sent To -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="payment_sent_for" v-model="formData.payment_sent_for"
                            class="form-control">
                    </div>
                    <!-- Tags -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="balance_before_trx" disabled v-model="formData.balance_before_trx"
                            class="form-control" required>
                    </div>
                    <!-- Balance After Transaction -->
                    <div class="form-group">
                        <label for="balance_after_trx">Balance After Transaction:</label>
                        <input type="number" id="balance_after_trx" disabled v-model="formData.balance_after_trx"
                            class="form-control" required>
                    </div>
                    <!-- Submit Button -->
                    <div class="form-group submit-button">
                        <button type="submit" class="btn btn-primary">{{ editingTransaction ? 'Update' : 'Add' }}
                            Transaction</button>
                    </div>
                </div>
            </form>
...
export default {
    ...
    methods: {
        ...
        async onBankNameChange() {
            this.formData.balance_before_trx = this.selectedBank.current_balance;
            this.formData.balance_after_trx = parseFloat(this.formData.balance_before_trx) + parseFloat(this.formData.credit) - parseFloat(this.formData.debit);
            this.formData.short_name= this.selectedBank.short_name;
        },
        async onInput(type) {
            if (type == 'credit') {
...
select {
    ...
    background-image: url("data:image/svg+xml;utf8,<svg fill='currentColor' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M7 10l5 5 5-5H7z'/></svg>");
