  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      <div class="col-auto px-sm-2 px-0 bg-dark min-vh-100">
        ...
        <div
          class="collapse navbar-collapse d-lg-flex flex-column align-items-start align-items-lg-start px-3 pt-2 text-white"
          id="menu"
        >
          ...
          >
            ...
            <li>
              ...
              >
                ...
                <li class="w-100 nav-item">
                  <router-link to="/view-all" class="nav-link px-0">
